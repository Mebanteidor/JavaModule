...
class ExpenseManager {
	...
	protected Expense[] matchExpenses;
	int size = 0;
	static int index = 0;
	...
	ExpenseManager(int size) {
		...
		matchExpenses = new Expense[size];
		this.size = size;
	}
	...
	public void clearArr(){
		for(int i = 0 ; i < matchExpenses.length ; i++){
			matchExpenses[i] = null;
		}
	}
...
class FifthExample {
	...
	private static void findingExpense() {
		...
		try {
			Expense[] mArray = _mgr.findExpense(detail);
